    ...
    <footer id="footer" class="bg-gray-500 text-white text-center p-4 w-full">
      ...
      <div class="container mx-auto px-4 py-16" id="el-ui8kcqbo">
        ...
        >
          {/* <!-- Company Info --> */}
          <div id="el-58q5kowt">
            <h3 class="text-2xl font-bold text-white mb-6" id="el-todze862">
              LearnVerse
            </h3>
            ...
            <div class="flex justify-center items-center gap-4" id="el-svwr51ye">
              <img
          ...
          <div id="el-09c5rtsz">
            ...
            <ul class="space-y-4" id="el-gmdl8mv7">
              <li class="flex items-center gap-3" id="el-tj6taxoe">
                <i
                  class="fa-solid fa-location-dot text-orange-500"
                  id="el-fm05uuar"
                ></i>
                <span id="el-sjplxdhj">
              ...
              <li class="flex items-center gap-3" id="el-j5fz0i1m">
                <i
                  class="fa-solid fa-phone text-orange-500"
                  id="el-2ja5ajc1"
                ></i>
              ...
              <li class="flex items-center gap-3" id="el-ug7vffqp">
                <i
                  class="fa-solid fa-envelope text-orange-500"
                  id="el-r9lsyhgb"
                ></i>
              ...
              <li class="flex items-center gap-3" id="el-h1zqtz1h">
                <i
                  class="fa-solid fa-clock text-orange-500"
                  id="el-21slrgx8"
                ></i>
